...
<section id="services" class="services">
    <div class="container">
        ...
        <div class="row">
            ...
            <component name="components.servicessection" $styles="" $text1="Горизонтальный токарный станок ЧПУ Okuma LB 15 II"
            ...
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: 55px" $text1="Горизонтальный токарный станок с ЧПУ SOLEX NL254 HC"
            ...
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: auto" $text1="Горизонтальный токарный станок Z-MAT FL400"
            ...
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: auto" $text1="Вертикально-обрабатывающий центр Z-MAT VMC1050"
            ...
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: auto" $text1="Вертикально-обрабатывающий центр Z-MAT VMC700E"
                                                         $text2="Размер стола 1300ммх520мм; Макс. нагрузка на стол 750кг; Кол-во инструмента — 24шт; Перемещение по осям X/Y/Z, мм - 1050/500/600."/>
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: auto" $text1="Вертикально-обрабатывающий центр GOODWAY GLS 2000 M"
            ...
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: auto" $text1="Ленточнопильный станок 400 В JET HVBS-712K"
            ...
            <component name="components.servicessection" $styles="margin-left: auto; margin-right: auto" $text1="Электроэрозионный вырезной станок REALREZ 630"
        ...
        <div class="row">
            <div class="col-lg-3">
                <ul class="nav nav-tabs flex-column">
                    <component name="components.servicesfeaturessection" $tabnum="1" $active="active show" $text="Токарные работы"/>
                    <component name="components.servicesfeaturessection" $tabnum="2" $active="" $text="Фрезерные работы"/>
                    <component name="components.servicesfeaturessection" $tabnum="3" $active="" $text="Сварка металлов"/>
                    <component name="components.servicesfeaturessection" $tabnum="4" $active="" $text="Цинкование металлов"/>
                    <component name="components.servicesfeaturessection" $tabnum="5" $active="" $text="Прокатка металлов"/>
                </ul>
            </div>
        <div class="col-lg-9 mt-4 mt-lg-0">
            <div class="tab-content">
                <component name="components.tabcontent" $active="active show" $text1="Токарные работы" $text2="Обработка резанием"
                                                        ...
                                                        $imagenum="1" $tabnum="1"/>
                <component name="components.tabcontent" $text1="Фрезерные работы" $text2="Обработка резанием"
                                                        ...
                                                        $imagenum="2" $tabnum="2"/>
                <component name="components.tabcontent" $text1="Сварка металлов" $text2=""
                                                        ...
                                                        $imagenum="3" $tabnum="3"/>
                <component name="components.tabcontent" $text1="Цинкование" $text2="Защита поверхности детали"
                                                        ...
                                                        $imagenum="4" $tabnum="4"/>
                <component name="components.tabcontent" $text1="Прокатка металла" $text2="Обработка металлов давлением"
