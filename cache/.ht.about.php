...
<section class="page-section" id="services">
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5">
            <?php Facade::Run("components.skillssection", array_merge($__tpl_data, array("__component_part" => "begin"), array("icon" => "-cart fs-1", "text1" => "Мы предлагаем своим клиентам адекватные цены.", "text2" => "Также у нас существует система скидок.", "__component_part" => "begin")), $__tpl->getFacade()->getPath(), $__tpl->getFacade()->getUrl()); ?>
            <?php Facade::Run("components.skillssection", array_merge($__tpl_data, array("__component_part" => "begin"), array("icon" => "-calendar2-check fs-1", "text1" => "Сроки изготовления заказа на металлообработку максимально короткие.", "text2" => "Это удается достичь за счет грамотной организации труда, полностью автоматизированного производства и опытных специалистов.", "__component_part" => "begin")), $__tpl->getFacade()->getPath(), $__tpl->getFacade()->getUrl()); ?>
            ...
            <?php Facade::Run("components.skillssection", array_merge($__tpl_data, array("__component_part" => "begin"), array("icon" => "-tools fs-1", "text1" => "Мы оказываем высокий спектр услуг по металлообработке.", "text2" => "Начиная токарной обработкой, заканчивая сваркой металла.", "__component_part" => "begin")), $__tpl->getFacade()->getPath(), $__tpl->getFacade()->getUrl()); ?>
        </div>
    </div>
</section>
...
} // tpl_dced056a5b01c18eb54ee46d16006722
